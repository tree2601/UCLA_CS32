...
public:
	Exit(double level_x, double level_y, StudentWorld* p);
...
public:
	Pit(double level_x, double level_y, StudentWorld* p);
	virtual void doSomething();
private:
...
public:
	Flame(double level_x, double level_y, int dir, StudentWorld* p);
	virtual void doSomething();
private:
...
public:
	Vomit(double level_x, double level_y, int dir, StudentWorld* p);
	virtual void doSomething();
private:
};
//--------------Landmine---------------
...
public:
	Landmine(double level_x, double level_y, StudentWorld* p);
	virtual bool canBeDamaged() const {
		return true;
	}
	virtual bool beLandmine() {
...
public:
	Goodie(int ID, double level_x, double level_y, StudentWorld* p);
	virtual void doSomething();
	void bePickedUp();
...
public:
	Vaccine_Goodie(double level_x, double level_y, StudentWorld* p);
...
public:
	Flame_Goodie(double level_x, double level_y, StudentWorld* p);
	virtual void bePickedSpecific();
private:
};
//-----------------Landmine goodie-------------
...
public:
	Landmine_Goodie(double level_x, double level_y, StudentWorld* p);
	virtual void bePickedSpecific();
private:
};
