...
Exit::Exit(double level_x, double level_y, StudentWorld* p) :ActivatingObject(IID_EXIT, level_x, level_y, right, 1, p) {
...
//--------------Pit---------------------------
Pit::Pit(double level_x, double level_y, StudentWorld* p) : ActivatingObject(IID_PIT, level_x, level_y, right, 1, p)
{}
...
//--------------Flame-----------------------
Flame::Flame(double level_x, double level_y, int dir, StudentWorld* p) :ActivatingObject(IID_FLAME, level_x, level_y, dir, 0, p)
{}
...
//---------------Vomit-----------------
Vomit::Vomit(double level_x, double level_y, int dir, StudentWorld* p) :ActivatingObject(IID_VOMIT, level_x, level_y, dir, 0, p)
{}
...
//--------------Landmine---------------
Landmine::Landmine(double level_x, double level_y, StudentWorld* p) :ActivatingObject(IID_LANDMINE, level_x, level_y, right, 1, p) {
	active = false;
	m_ticks = 30;
...
//---------------Goodie----------------
Goodie::Goodie(int ID, double level_x, double level_y, StudentWorld* p) :ActivatingObject(ID, level_x, level_y, right, 1, p) {
...
//---------------Vaccine_Goodie------------------------
Vaccine_Goodie::Vaccine_Goodie(double level_x, double level_y, StudentWorld* p) :Goodie(IID_VACCINE_GOODIE, level_x, level_y, p) {
...
//---------------Flame_Goodie-------------------------
Flame_Goodie::Flame_Goodie(double level_x, double level_y, StudentWorld* p) : Goodie(IID_GAS_CAN_GOODIE, level_x, level_y, p) {
...
//-------------Landmine_Goodie---------------------------
Landmine_Goodie::Landmine_Goodie(double level_x, double level_y, StudentWorld* p) : Goodie(IID_LANDMINE_GOODIE, level_x, level_y, p) {
